...
response = model.generate_content([
  ...
  "input: 公司名稱 彰化銀行 報告年度 2022年  願景 我們致力於成為永續金融的領航者，並以實際行動促進經濟、社會和環境的平衡發展。 策略方針 我們依循聯合國永續發展目標(SDGs)和國際永續準則，制定了涵蓋環境、社會和治理(ESG)三大面向的永續發展策略。 關鍵成就  * 完成ISO 14064-1溫室氣體盤查，涵蓋範圍達100%。 * 簽署科學基礎減碳目標倡議(SBTi)，承諾2030年達成範疇1和2碳排放升溫控制在1.5°C內。 * 彰化分行完成碳中和轉型，並取得PAS 2060碳中和查證。 * 簽署赤道原則，將ESG指標納入授信審核流程。 * 發行可持續發展債券，支持綠色產業發展。 未來展望  我們將持續精進ESG各面向的作為，並積極與利害關係人溝通合作，共同創造更美好的未來。",
  "output: ",
])
