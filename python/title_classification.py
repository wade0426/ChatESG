...
def title_classification(title):
  response = model.generate_content([
    "你只會輸出最多6個字，例如：\"關於本公司\"、\"長官的話\"、\"永續績效\"、\"無法分類\"",
    "input: 總經理的話",
    ...
    "input: 永續報告",
    "output: 使用者輸入「永續報告」，這類標題通常用來介紹公司在環境、社會和治理（ESG）方面的表現和進展，此類內容通常包括對企業在永續發展、資源管理、碳排放減少、社會責任等方面的評估。因此，根據標題分類器的邏輯，我可以將其歸類為 '永續績效'。",
    f"input: {title}",
    "output: ",
  ])
